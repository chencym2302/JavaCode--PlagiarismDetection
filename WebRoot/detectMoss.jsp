...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="detectmoss.jsp"><span
	...
	<div class="container">
		...
		<div class="col-md-12">
			<div class="panel panel-default" style="padding-bottom: 0px;">
				<div class="panel-heading">Moss查重</div>
				<div class="panel-body">
					<form id="f_codeDetectmoss" class="form-horizontal">
						<div class="form-group" style="margin-top: 15px">
							...
							<div class="col-sm-4" style="width: 30%; text-align: left">
								<button type="submit" onclick="codeDetect()"
									...
									style="width: 40%; margin-top: 0px; float: right">开始查重</button>
							</div>
							<div class="col-sm-4" style="width: 10%; text-align: left">
								<button type="submit" onclick="getResultsList()"
									class="btn btn-default"
									style="width: 100%; margin-top: 0px; float: right">刷新</button>
							</div>
	...
	<script src="js/detectmoss.js" type="text/javascript"></script>
	<script>
