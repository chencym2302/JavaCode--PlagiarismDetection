...
public interface JavaListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterLoop(@NotNull JavaParser.LoopContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#loop}.
	 * @param ctx the parse tree
	 */
	void exitLoop(@NotNull JavaParser.LoopContext ctx);
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#conditionalIf}.
	 * @param ctx the parse tree
	 */
	void enterConditionalIf(@NotNull JavaParser.ConditionalIfContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#conditionalIf}.
	 * @param ctx the parse tree
	 */
	void exitConditionalIf(@NotNull JavaParser.ConditionalIfContext ctx);
